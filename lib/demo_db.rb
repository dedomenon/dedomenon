...
account = Account.new(:name => "demo account", :country => "Belgium")
      ...
      #details
      #########
      text_type = DataType.find_by_name "madb_short_text"
      long_text_type = DataType.find_by_name "madb_long_text"
      date_type = DataType.find_by_name "madb_date"
      integer_type = DataType.find_by_name "madb_integer"
      ddl_type = DataType.find_by_name "madb_choose_in_list"
      email_type = DataType.find_by_name "madb_email"
      web_url_type = DataType.find_by_name "madb_web_url"
      ...
      fax_detail.save
      website_detail = Detail.new :name => "website", :data_type => web_url_type, :status_id => 1, :database => customers_database
      website_detail.save
